...
class FeedbackMsg {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.trajectories.forEach((val) => {
      bufferOffset = cohan_msgs.msg.Trajectory.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.trajectories[i] = cohan_msgs.msg.Trajectory.deserialize(buffer, bufferOffset)
    }
  ...
  static getMessageSize(object) {
    ...
    object.trajectories.forEach((val) => {
      length += cohan_msgs.msg.Trajectory.getMessageSize(val);
    });
  ...
  static datatype() {
    ...
    return 'hateb_local_planner/FeedbackMsg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '686540d6eb9e37725664ef2b8e7b41ad';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.trajectories !== undefined) {
      ...
      for (let i = 0; i < resolved.trajectories.length; ++i) {
        resolved.trajectories[i] = cohan_msgs.msg.Trajectory.Resolve(msg.trajectories[i]);
      }
    }
    else {
