...
class TrajectoryStamped {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TrajectoryStamped(null);
  ...
  static datatype() {
    ...
    return 'cohan_msgs/TrajectoryStamped';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '23f33cdc683ccd7c358b56676d7033a4';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TrajectoryStamped(null);
...
module.exports = TrajectoryStamped;
