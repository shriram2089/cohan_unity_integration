...
"""autogenerated by genpy from cohan_msgs/TrackedAgent.msg. Do not edit."""
import codecs
import sys
...
class TrackedAgent(genpy.Message):
  _md5sum = "e6d0cc6bc60fdd6b12a54123fbdffc28"
  _type = "cohan_msgs/TrackedAgent"
...
"""
  ...
  __slots__ = ['track_id','state','type','name','segments']
  _slot_types = ['uint64','int8','int8','string','cohan_msgs/TrackedSegment[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       track_id,state,type,name,segments
    ...
    """
    if args or kwds:
      super(TrackedAgent, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cohan_msgs.msg.TrackedSegment()
        start = end
        end += 1
