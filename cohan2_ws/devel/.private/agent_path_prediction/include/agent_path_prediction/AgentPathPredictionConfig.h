...
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(AgentPathPredictionConfig::AbstractParamDescriptionConstPtr(new AgentPathPredictionConfig::ParamDescription<bool>("velobs_use_ang", "bool", 0, "whether to use angular velocity for velocity-obstacle calculation", "", &AgentPathPredictionConfig::velobs_use_ang)));
//#line 292 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(AgentPathPredictionConfig::AbstractParamDescriptionConstPtr(new AgentPathPredictionConfig::ParamDescription<bool>("velobs_use_ang", "bool", 0, "whether to use angular velocity for velocity-obstacle calculation", "", &AgentPathPredictionConfig::velobs_use_ang)));
