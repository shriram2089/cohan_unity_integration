...
class AgentPose(genpy.Message):
  _md5sum = "eba4892371bf047acb069910bf104f63"
...
"""
  ...
  _slot_types = ['int8','int32','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_bi3I().pack(_x.type, _x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.type, _x.id, _x.pose.header.seq, _x.pose.header.stamp.secs, _x.pose.header.stamp.nsecs,) = _get_struct_bi3I().unpack(str[start:end])
      start = end
      end += 4
