...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_B3d().pack(_x.ac_present, _x.charge_rate, _x.discharge_rate, _x.charge))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ac_present, _x.charge_rate, _x.discharge_rate, _x.charge,) = _get_struct_B3d().unpack(str[start:end])
