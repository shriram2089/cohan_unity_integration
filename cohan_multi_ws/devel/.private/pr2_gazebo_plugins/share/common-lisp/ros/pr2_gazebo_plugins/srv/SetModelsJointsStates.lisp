...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SetModelsJointsStates-request>)))
  ...
  (cl:format cl:nil "string[] model_names                                      # name of the model~%pr2_gazebo_plugins/ModelJointsState[] model_joints_states # model pose and joint positions~%~%================================================================================~%MSG: pr2_gazebo_plugins/ModelJointsState~%geometry_msgs/Pose[] model_pose                          # set as single element array if user wishes to specify model pose, otherwise, leave empty~%string[] joint_names                                     # list of joint names~%float64[] joint_positions                                 # list of desired joint positions, should match joint_names~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SetModelsJointsStates-request)))
  "Returns full string definition for message of type 'SetModelsJointsStates-request"
  (cl:format cl:nil "string[] model_names                                      # name of the model~%pr2_gazebo_plugins/ModelJointsState[] model_joints_states # model pose and joint positions~%~%================================================================================~%MSG: pr2_gazebo_plugins/ModelJointsState~%geometry_msgs/Pose[] model_pose                          # set as single element array if user wishes to specify model pose, otherwise, leave empty~%string[] joint_names                                     # list of joint names~%float64[] joint_positions                                 # list of desired joint positions, should match joint_names~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
