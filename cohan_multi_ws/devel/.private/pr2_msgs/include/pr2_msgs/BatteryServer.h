...
struct BatteryServer_
{
  ...
  _inhibited_type inhibited;
   ...
   typedef std::vector< ::pr2_msgs::BatteryState_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::pr2_msgs::BatteryState_<ContainerAllocator> >> _battery_type;
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::pr2_msgs::BatteryServer_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.battery.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::pr2_msgs::BatteryState_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.battery[i]);
    }
    if (v.battery.empty() || false)
      s << "]";
  }
