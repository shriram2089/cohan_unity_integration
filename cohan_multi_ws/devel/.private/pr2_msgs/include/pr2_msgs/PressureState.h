...
struct PressureState_
{
  ...
  _header_type header;
   ...
   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _l_finger_tip_type;
  _l_finger_tip_type l_finger_tip;

   typedef std::vector<int16_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int16_t>> _r_finger_tip_type;
...
struct Printer< ::pr2_msgs::PressureState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::pr2_msgs::PressureState_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "l_finger_tip: ";
    if (v.l_finger_tip.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.l_finger_tip.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int16_t>::stream(s, true ? std::string() : indent + "    ", v.l_finger_tip[i]);
    }
    if (v.l_finger_tip.empty() || true)
      s << "]";
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "r_finger_tip: ";
    if (v.r_finger_tip.empty() || true)
      s << "[";
    for (size_t i = 0; i < v.r_finger_tip.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<int16_t>::stream(s, true ? std::string() : indent + "    ", v.r_finger_tip[i]);
    }
    if (v.r_finger_tip.empty() || true)
      s << "]";
  }
