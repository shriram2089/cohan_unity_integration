...
"""autogenerated by genpy from cohan_gazebo/setGoal.msg. Do not edit."""
import codecs
import sys
...
class setGoal(genpy.Message):
  _md5sum = "37dce9f174cd54246b8b68dda92de7d8"
  _type = "cohan_gazebo/setGoal"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(setGoal, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_q3I().pack(_x.id, _x.goal.header.seq, _x.goal.header.stamp.secs, _x.goal.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.id, _x.goal.header.seq, _x.goal.header.stamp.secs, _x.goal.header.stamp.nsecs,) = _get_struct_q3I().unpack(str[start:end])
      start = end
      end += 4
