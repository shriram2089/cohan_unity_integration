...
(cl:defclass <TrajectoryMsg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (trajectory
    :reader trajectory
    :initarg :trajectory
    :type (cl:vector hateb_local_planner-msg:TrajectoryPointMsg)
   :initform (cl:make-array 0 :element-type 'hateb_local_planner-msg:TrajectoryPointMsg :initial-element (cl:make-instance 'hateb_local_planner-msg:TrajectoryPointMsg))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrajectoryMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrajectoryMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hateb_local_planner-msg:<TrajectoryMsg> is deprecated: use hateb_local_planner-msg:TrajectoryMsg instead.")))
...
(cl:defmethod trajectory-val ((m <TrajectoryMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hateb_local_planner-msg:trajectory-val is deprecated.  Use hateb_local_planner-msg:trajectory instead.")
  (trajectory m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrajectoryMsg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'trajectory)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'hateb_local_planner-msg:TrajectoryPointMsg))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrajectoryMsg>)))
  ...
  "hateb_local_planner/TrajectoryMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrajectoryMsg)))
  "Returns string type for a message object of type 'TrajectoryMsg"
  "hateb_local_planner/TrajectoryMsg")
