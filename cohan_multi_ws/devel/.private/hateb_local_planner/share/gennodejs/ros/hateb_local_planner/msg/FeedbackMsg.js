...
class FeedbackMsg {
  ...
  static messageDefinition() {
    ...
    hateb_local_planner/TrajectoryMsg[] trajectories
    ...
    ================================================================================
    MSG: hateb_local_planner/TrajectoryMsg
    # Message that contains a trajectory for mobile robot navigation
    
    std_msgs/Header header
    hateb_local_planner/TrajectoryPointMsg[] trajectory
    
    
    
    ================================================================================
    MSG: hateb_local_planner/TrajectoryPointMsg
