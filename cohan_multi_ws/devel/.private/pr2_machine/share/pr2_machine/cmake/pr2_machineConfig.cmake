...
if("TRUE" STREQUAL "TRUE")
  set(pr2_machine_SOURCE_PREFIX /home/shari/cohan_multi_ws/src/pr2_common/pr2_machine)
  set(pr2_machine_DEVEL_PREFIX /home/shari/cohan_multi_ws/devel/.private/pr2_machine)
  ...
  set(pr2_machine_INSTALL_PREFIX /home/shari/cohan_multi_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shari/cohan_multi_ws/src/pr2_common/pr2_machine/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT pr2_machine_NUM_DUMMY_TARGETS)
      set(pr2_machine_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::pr2_machine::wrapped-linker-option${pr2_machine_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR pr2_machine_NUM_DUMMY_TARGETS "${pr2_machine_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::pr2_machine::wrapped-linker-option${pr2_machine_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND pr2_machine_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND pr2_machine_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/shari/cohan_multi_ws/devel/.private/pr2_machine/lib;/home/shari/cohan_multi_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(pr2_machine_EXPORTED_TARGETS ${${pr2_machine_dep}_EXPORTED_TARGETS})
endforeach()
