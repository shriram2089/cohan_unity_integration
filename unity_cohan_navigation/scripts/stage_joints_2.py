...
def main():
    ...
    # print(joint_states.name.index("head_pan_joint"))

    joint_states.name.pop(29)
    joint_states.name.pop(29)
    joint_states.position.pop(29)
    joint_states.position.pop(29)
    ...
    r = rospy.Rate(50)
    joint_states_pub = rospy.Publisher("/joint_states", JointState, queue_size=1,latch=True)
    cnt=0
    # while cnt<10:
