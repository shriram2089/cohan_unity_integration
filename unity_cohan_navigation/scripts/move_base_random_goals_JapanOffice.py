...
class RandomGoalPublisher:
    def __init__(self):
        ...
        self.goal_positions = [[-4.1 , -18.1 ,1.5707],  [7.4 , 10.7 , -1.5707] , [8.63 , 9.7 , 0],[14.5 , 6 , -2*1.5707],[6.7 , 3.7 , -1.5707],[0 , 0 , -2*1.5707]]
        self.kitchen_goal =  [-4.1 , -8.3  , 1.5707]
        self.goal_timeout = rospy.Duration(25)         
        self.distance_threshold = 0.2                  
        self.stuck_check_interval = 5.0               
        self.min_progress = 0.1            
    ...
    def publish_random_goal(self):
        while not rospy.is_shutdown():
            ...
            random_goals = random.sample(self.goal_positions, 2)
            goal_selected = random_goals + [self.kitchen_goal]
            for goal_position in goal_selected:
                goal = PoseStamped()
...
if __name__ == '__main__':
    try:
        ...
        # rospy.sleep(10.0)
        rospy.loginfo("Starting to publish random goals...")
